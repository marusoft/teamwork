...
const addAllsqlTableQueries = `
      ...
      VALUES ('kehinde', 'alimi', 'alimi@teamwork.com', '${hashedPassword}', 'male', 'admin', 'HR', '3, Olourunosebi street, Oni, Lagos.'),
             ('moyosore', 'omodada', 'moyosore@teamwork.com', '${hashedPassword}', 'female', 'employee', 'Engineering' ,'3,Talomoola Street, ajumobi, Lagos.');

      INSERT INTO gifs(gifownerId, title, imageUrl) 
      VALUES ( 2, 'cat developer', 'http://res.cloudinary.com/marusofteamwork/image/upload/v1573631083/pfgzp33vasqt5bpap3fe.gif'),
             ( 1, 'cat developer', 'http://res.cloudinary.com/marusofteamwork/image/upload/v1573631083/pfgzp33vasqt5bpap3fe.gif');
      `;
